    ...
    void InitializeBoard()
    {
        ...
        for (int y = 0; y < boardHeight; y++)
        {
            for (int x = 0; x < boardWidth; x++)
            {
                ...
                backgroundPosition.x += (backgroundRectTransform.rect.width * ((x + 1))); // điều chỉnh vị trí theo chiều ngang
                backgroundPosition.y += backgroundRectTransform.rect.height * ((y + 0.5f)); // điều chỉnh vị trí theo chiều dọc
                position.x += (rectTransform.rect.width * (x + 1)); // điều chỉnh vị trí theo chiều ngang
                position.y += rectTransform.rect.height * (y + 0.5f); // điều chỉnh vị trí theo chiều dọc
