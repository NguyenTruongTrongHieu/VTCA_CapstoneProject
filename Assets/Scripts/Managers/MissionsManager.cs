...
public class MissionsManager : MonoBehaviour
{
    ...
    public void RewardClaiming(int missionIndex)
    {
        ...
        CurrencyManager.instance.StartCoroutine(CurrencyManager.instance.AddCoins(UIManager.instance.missionsDescriptionTexts[missionIndex].transform.position, missions[missionIndex].reward, false, 0f, UIManager.instance.missionsDescriptionTexts[missionIndex].transform.parent)); // Add coins to the player's currency
